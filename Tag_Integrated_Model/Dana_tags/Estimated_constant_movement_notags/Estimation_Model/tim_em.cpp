...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
 ...
 cout<<"nt"<<endl<<nt<<endl;
  ...
  init_abund_TRUE.allocate(1,np,1,np,1,nreg,1,na,"init_abund_TRUE");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
 ...
 int T_lgth_YR=sum(nr)*nyr;
  ln_T_YR.allocate(1,T_lgth_YR,1,T_lgth-1,-10,3,phase_T_YR,"ln_T_YR");
  ln_T_CNST.allocate(1,T_lgth,1,T_lgth-1,-10,3,phase_T_CNST,"ln_T_CNST");
 ...
 int sel_lgth=sum(nr);
  ...
  log_sel_beta3.allocate(1,sel_lgth,1,fishfleet,-10,5,ph_sel_dubl,"log_sel_beta3");
  log_sel_beta4.allocate(1,sel_lgth,1,fishfleet,-10,5,ph_sel_dubl,"log_sel_beta4");
 ...
 int F_lgth=sum(nr)*nyr;
  ln_F.allocate(1,F_lgth,1,fishfleet,-7,2,ph_F,"ln_F");
 ...
 ivector tag_age(1,nyr_rel);
  ...
  recaps.allocate(1,nps,1,nr,1,nyr_rel,1,nag,1,tag_age,1,nps,1,nr,"recaps");
    ...
    recaps.initialize();
  #endif
  ln_rec_prop.allocate(1,parpops,1,nr,-4,0,-1,"ln_rec_prop");
  ln_rec_prop_year.allocate(1,parpops,1,nr,1,nyr,-1,"ln_rec_prop_year");
 int dev_lgth=nps*(nyr-1);
  ln_rec_devs_RN.allocate(1,nps,1,nyr-1,-40,40,ph_rec,"ln_rec_devs_RN");
  ln_abund_devs.allocate(1,nps,1,nag,-10,10,ph_abund_devs,"ln_abund_devs");
  abund_devs.allocate(1,nps,1,nages,"abund_devs");
  #ifndef NO_AD_INITIALIZE
    abund_devs.initialize();
  #endif
