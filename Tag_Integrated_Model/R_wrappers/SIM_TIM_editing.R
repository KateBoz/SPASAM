...
f.select.est$bias=((f.select.est$val.true-f.select.est$value)/f.select.est$val.true)*100
...
s.select.est$bias=((s.select.est$val.true-s.select.est$value)/s.select.est$val.true)*100
