...
// need these for some if the init parameter arrays below
 ...
 // DG
 //#########################################################################################################
   init_3darray ln_T_est_reg(1,nyrs,1,parreg,1,parreg,phase_T_reg);  //DO NOT USE
   init_matrix ln_T_CNST_reg(1,parreg,1,parreg,phase_T_CNST_reg);    //DO NOT USE
 ///#####################################################################################################
     init_3darray ln_T_est_pop(1,nyrs,1,nps,1,nps-1,phase_T_pop);  
     init_matrix ln_T_CNST_pop(1,nps,1,nps-1,phase_T_CNST_pop);
  ...
  //movement parameters, time-invariant
