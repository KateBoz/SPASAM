...
//########################################################################################################
  ...
  init_3darray input_apport(1,np,1,nreg,1,nf)
//################################################################################################################
//################################################################################################################
//################################################################################################################
                                             ...
                                             if(parse_TAC==1) //use observed data to parse input_TAC by region // if multiple fleets then evenly distribute across fleets
                                                {
                                                 ...
                                                 if(parse_TAC_source==4)
                                                  ...
                                                  if(calc_TAC_from_uMSY==1)
                                                   {
                                                    TAC(j,r,x,y)=input_apport(j,r,x)*input_u(j,r,x)*biomass_population(j,y)/nfleets(j);
                                                   }
                                                  if(calc_TAC_from_uMSY==2)
                                                   {
                                                    TAC(j,r,x,y)=input_apport(j,r,x)*input_u(j,r,x)*biomass_AM(j,r,y)/nfleets(j);
                                                   }
                                                  }
                                                 }
                                               ...
                                               if(parse_TAC==1) //use observed data to parse input_TAC by region // if multiple fleets then evenly distribute across fleets
                                                {
                                                 ...
                                                 if(parse_TAC_source==4)
                                                  {
                                                    u(j,r,x)=input_apport(j,r,x)*input_u(j,r,x)/nfleets(j);
                                                  }
                                                 }
