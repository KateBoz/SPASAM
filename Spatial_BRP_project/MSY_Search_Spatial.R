...
WD<-"G:\\SPASAM CODING\\MS_1_CODE\\Hake\\Model_runs\\_Hake_Runs\\BASE_Alt"
setwd(WD)
WD<<-WD  
...
MSY_search<-function(wd=WD) {
  ...
  #set up the parallel processing to run msy search
  ...
  #do the parallel processing over the loops and save the results
  
  #test if parallel is working
  stime <- system.time({
    
  #i = 2 # for troubleshooting
    #run parallel  
