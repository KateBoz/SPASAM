...
#HAKE runs
#########################################################
#for multifolder runs
#########################################################
#folder<-"G:\\SPASAM CODING\\MS_1_CODE\\Hake\\Model_runs"

#folder<-"E:\\SPASAM CODING\\MS_1_CODE\\Hake\\Model_runs"
...
#################################################
#for single folder runs

WD<-"C:\\Users\\katelyn.bosley\\Desktop\\Today\\HAKE\\Metapopulation"
setwd(WD)
WD<<-WD  
